...
namespace IIS.Kursovaya
{
    ...
    public class Карта : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya.ВидКарты fТипКарты;
        ...
        public virtual IIS.Kursovaya.ВидКарты ТипКарты
        {
            get
            {
                ...
                IIS.Kursovaya.ВидКарты result = this.fТипКарты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартаE", typeof(IIS.Kursovaya.Карта));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартаL", typeof(IIS.Kursovaya.Карта));
                }
            }
        }
    }
