...
define('ember-app/mixins/regenerated/models/i-i-s-kursovaya-\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446-\u0432\u0445\u043E\u0434\u0430', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('РегистрацВходаE', 'i-i-s-kursovaya-регистрац-входа', {
      ...
      комната: (0, _attributes.belongsTo)('i-i-s-kursovaya-комната', 'Комната', {
        номерКомнаты: (0, _attributes.attr)('Комната', { index: 2, hidden: true })
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        ...
        'i-i-s-kursovaya-регистрац-входа': 'id,дата,комната,*входСотрудника,*входГостя',
